...
//var color1 = '#' + Math.random().toString(16).slice(2, 8).toUpperCase();
//var color2 = hexToComplimentary(color1);
//
//console.log(hexToHSL(color1));
//console.log(hexToHSL(color2));
//
//var tmp;
//if (hexToHSL(color1)['h'] < hexToHSL(color2)['h']) {
//    tmp = color1;
//    color1 = color2;
//    color2 = tmp;
